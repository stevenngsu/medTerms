...
A wordle consisting of medical terms from a medical dictionary that start with the letters A, B, or C. Affixes were compiled, compared them with a dictionary text document, and created terms to form a json file. The results were filtered to only consist of words thay started with the letters A, B, and C.
